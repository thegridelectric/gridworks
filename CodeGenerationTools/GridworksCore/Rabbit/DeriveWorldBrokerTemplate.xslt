<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl" xmlns:xs="http://www.w3.org/2001/XMLSchema">
    ...
    <xsl:template match="/">
        <FileSet>
                    <FileSetFile>
                        <xsl:element name="RelativePath"><xsl:text>../../rabbit/rabbitconfig/rabbit_definitions_dev_test.json</xsl:text></xsl:element>
    ...
    <xsl:for-each select="$airtable//RabbitPairings/RabbitPairing">
        <xsl:text>,
    {
        "source":"</xsl:text><xsl:value-of select="From"/><xsl:text>mic",
        "vhost":"d1__1",
        "destination":"</xsl:text><xsl:value-of select="To"/><xsl:text>",
        "destination_type":"exchange",
